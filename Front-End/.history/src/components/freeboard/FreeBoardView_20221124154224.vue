    ...
    <div>
      ...
      <div class="CommentTitle">
        ...
        <v-simple-table style="width: 100%; background-color: white; color: hsla(0, 76%, 3%, 0.6)">
          <tr v-for="item in article.comments" :key="item.commentNo">
            ...
            <div v-bind:style="{ 'text-indent': item.depth * 30 + 'px' }">
              ...
              <div style="display: flex; margin-top: 20px; margin-bottom: 10px; white-space: nowrapstyle="text-indent:0px"">
                <p  v-if="item.parentCommentNo != 0">↪</p>
                {{ item.content }}
              </div>
