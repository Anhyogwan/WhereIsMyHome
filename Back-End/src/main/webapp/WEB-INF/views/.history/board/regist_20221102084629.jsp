								...
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="p-5">
											...
											<form class="user" id="registForm" method="post"
												enctype="multipart/form-data" action=${root}/board/regist>
												<!-- <input type="hidden" name="act" value="regist"> -->
												<div class="form-group">
													<input type="text" class="form-control form-control-user"
														id="exampleInput1" aria-describedby="emailHelp" name="subject"
														placeholder="제목">
												</div>
												<div class="form-group">
													<input type="text" class="form-control form-control-user"
														name="userId" id="userId" value="${userinfo.userId}" readonly>
												</div>

												<div class="form-group">
													<input type="textarea" class="h-100 form-control form-control-user"
														id="exampleInput2" aria-describedby="emailHelp" name="content"
														placeholder="내용">
												</div>

												<div class="form-group" align="left">
													<label for="upfile">첨부파일:</label>
													<input type="file" class="form-control border" name="upfile"
														multiple="multiple">
												</div>
												...
												<a class="btn btn-google btn-user btn-block"
													href="${root}/board/articles">나가기</a>
											</form>
											<hr>
										</div>
									</div>
