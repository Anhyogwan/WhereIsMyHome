    ...
    <body class="bg-gradient-primary">
      ...
      <script>
        ...
        document.getElementById("registboard").addEventListener("click", function () {
          let subject = document.getElementById("exampleInput1");
          let userId = document.getElementById("userId");
          let Content = document.getElementById("exampleInput2");
          let fileInfos = document.getElementById("upfile");
          var formData = new FormData(document.getEle);
          formData.append('subject', subject);
          formData.append('userId', userId);
          formData.append('content', Content);
          formData.append('fileInfos', fileInfos);
          ...
          fetch(`${root}/board/regist`, config)
