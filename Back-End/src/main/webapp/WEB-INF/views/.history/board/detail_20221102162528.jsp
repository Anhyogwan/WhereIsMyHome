              ...
              if (data.fileInfos != null) {
                ...
                files.forEach(function (file) {
                  file.addEventListener("click", function () {
                    ...
                    let formdata = new FormData().append("sfolder", file.getAttribute("sfolder"));
                    formdata.append("ofile", file.getAttribute("ofile"));
                    formdata.append("sfile", file.getAttribute("sfile"));

                    alert(formdata);
                    fetch(`${root}/board/download`, { method: "POST", body: formdata })
                      .then(location.href = `${root}/index`);
                  });
                });
              }
            });
